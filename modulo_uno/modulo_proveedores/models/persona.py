...
class Persona(models.Model): #paquete.clase
    ...
    sexo = fields.Selection(selection=[('femenino','Femenino'),('masculino','Masculino'),('otro','Otro')],
                            string="Sexo",
                            requiered=True,
                            default="otro")

    grado_estudio_id = fields.Many2one('personas.grados_estudio',
                                       string="Grado máximo de estudios",
                                       )

    dominios_email_ids = fields.Many2many('personas.nombre_cuentas_email',
                                          string="Dominios de correo"
                                          )
    autos_ids = fields.One2many('personas.autos', #modelo al que se hace referencia
